...
# ── Step 2: Ask AI to analyze and plan attack ─────────────
...
# ── Step 3: Execute the attack based on AI analysis ───────
def execute_ai_attack(analysis):
    ...
    # Execute attack — try the vulnerable function AI identified
...
# ── Step 5: Generate AI agent report ──────────────────────
def generate_ai_report(analyses, attack_results):
    ...
    for contract_name, analysis in analyses.items():
        ...
        if analysis.get("vulnerability_found") and succeeded:
            ...
            print(f"\n   [AI-FOUND] {contract_name} — vulnerability identified but attack blocked")
            print(f"   Type     : {analysis['vulnerability_type']}")
...
if __name__ == "__main__":
    ...
    # Focus on hello-world (auth bypass contract) for main attack
    ...
    if target_contract in sources:
        ...
        if analysis:
            ...
            # Execute attack based on AI analysis
    ...
    # Also quickly analyze other contracts
    ...
    # Schedule fund recovery if anything was drained
    if total_drained > 0:
